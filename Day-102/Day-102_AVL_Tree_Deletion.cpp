...
//4 cases exists for balancing the avl:-
// 1) LL -> right rotation on pivot A
// 2) RR -> left rotation on pivot A
// 3) LR -> left rotation on pivot B and then right rotation on pivot A
...
Node* deleteNode(Node* root, int data)
{
    ...
    else 
    {
        ...
        //the node to be deleed is leaf node
        ...
        {
            //finding immediate predecessor of data in the avl tree
